...
import './App.css';
import {MapContainer, GeoJSON, useMapEvents, CircleMarker, Polyline} from 'react-leaflet';
import {LatLngExpression} from "leaflet";
import borders from './ne_50m_land.json';
...
function App() {
  ...
  const [realPosition, setRealPosition] = useState<LatLngExpression | null>(null);
  ...
  return (
    <div>
      ...
      >
        ...
        <Polyline
          positions={[realPosition, clickedPosition]}
        />
        }
      </MapContainer>
    </div>
